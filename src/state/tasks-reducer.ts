...
import {v1} from 'uuid';
import {AddTodolistActionType, RemoveTodolistActionType, setTodolisAC, setTodolistType} from './todolists-reducer';
...
export const getTasksTC = (todoId: string) => (dispatch: any) => {
...
export const deleteTasksTC = (todoId: string, taskId: string) => (dispatch: any) => {
